		...
		<header id="header">
            <div class="container-lg">
                <div class="header-left">
                    <div class="logo">
                        <a href="#"><img src="{{ asset('public/assets/images/demos-img/logo.png') }}" alt="Molla Logo"></a>
                    </div>
                </div>
        ...
        <div id="main">
                ...
                <div class="row demos">
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-1.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_furniture1.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Furniture 1">
                            <h5>Furniture 1</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-2.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_furniture2.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-3.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_electronic1.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Electronic 1">
                            <h5>Electronic 1</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-4.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_electronic2.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-5.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion1.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 1">
                            <h5>Fashion 1</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-6.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion2.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 2">
                            <h5>Fashion 2</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-7.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion3.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 3">
                            <h5>Fashion 3</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-8.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fahion4.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 4">
                            <h5>Fashion 4</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-9.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion5.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 5">
                            <h5>Fashion 5</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-10.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_shoesstore.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-11.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_furniture_simple.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-12.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion_simple.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-13.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_market1.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Market">
                            <h5>Market</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-14.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_market.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Market (Full Width)">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-15.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_lookbook.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Lookbook 1">
                            <h5>Lookbook 1</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-16.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_lookbook2.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Lookbook 2">
                            <h5>Lookbook 2</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-17.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion7.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Fashion 7">
                            <h5>Fashion 7</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-18.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion8.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="ashion 8 (With Sidebar)">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-19.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_gamestore.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-20.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_bookstore.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-21.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_sport.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Furniture 2">
                            <h5>Sport Store</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-22.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_tools.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Furniture 2">
                            <h5>Tools Store</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-23.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_fashion9.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Furniture 2">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 homepages">
                        <a href="index-24.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/molla_extreme_sport.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Furniture 2">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category-list.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/21_shop_list.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Shop List">
                            <h5>Shop List</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category-2cols.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/22_shop_grid_2col.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Shop Grid">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/23_shop_grid_3col.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Shop Grid">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category-4cols.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/24_shop_grid_4col.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Book Store">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category-boxed.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/25_shop_boxed_no_sidebar.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Shop Boxed">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="category-fullwidth.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/26_shop_fullwidth_no_sidebar.jpg') }}" width="500"
                                height="385" class="molla-lz" style="padding-top: 77%" alt="Shop Fullwidth">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="product-category-boxed.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/27_shop_product_category_boxed.jpg') }}" width="500"
                                height="385" class="molla-lz" style="padding-top: 77%" alt="Product Category">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="product-category-fullwidth.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/28_shop_product_category_fullwidth.jpg') }}" width="500"
                                height="385" class="molla-lz" style="padding-top: 77%" alt="Product Category">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="cart.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/29_shop_shopping_cart.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="checkout.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/30_shop_checkout.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="wishlist.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/31_shop_wishlist.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 shoppages">
                        <a href="dashboard.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/shop_my_account.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/32_product_default.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product default">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-centered.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/33_product_centered.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product centered">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-extended.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/34_product_extended_description_boxed.jpg') }}" width="500"
                                height="385" class="molla-lz" style="padding-top: 77%"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-gallery.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/35_product_gallery.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product gallery">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-sticky.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/36_product_sticky_info.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product sticky info">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-sidebar.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/37_product_with_sidebar.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product with sidebar">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-fullwidth.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/38_product_fullwidth.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Product fullwidth">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 productpages">
                        <a href="product-masonry.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/39_product_masonry_sticky_info.jpg') }}" width="500"
                                height="385" class="molla-lz" style="padding-top: 77%"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="about.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/40_pages_aboutus.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="about-2.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/41_pages_aboutus_2.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="About Us 2">
                            <h5>About Us 2</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="contact.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/42_pages_contactus.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Contact Us">
                            <h5>Contact Us</h5>
                        </a>
                    </div>
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="contact-2.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/43_pages_contactus_2.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="login.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/44_pages_login.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="faq.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/45_pages_FAQ.jpg') }}" width="500" height="385"
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="404.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/46_pages_error_404.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Error 404 page">
                    ...
                    <div class="iso-item col-sm-6 col-md-4 col-lg-3 otherpages">
                        <a href="coming-soon.html" target="_blank">
                            <img src="{{ asset('public/assets/images/demos-img/lazy.png') }}"
                                data-oi="{{ asset('public/assets/images/demos-img/47_pages_coming_soon.jpg') }}" width="500" height="385"
                                class="molla-lz" style="padding-top: 77%" alt="Coming Soon page">
            ...
            <section class="section section-features">
				...
				<section class=" section section-elements container">
                                            ...
                                            <p class="text-center">Use your creativity and the power of Molla elements
                                                to create your pages,<br>check out some of them.</p>
                                            <br>
                                            <div class="row">
